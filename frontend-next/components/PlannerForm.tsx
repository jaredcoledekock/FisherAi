...
import { MetaResponse, PlanRequest, Preset } from "../lib/types";
...
export default function PlannerForm({
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const saved = window.localStorage.getItem("fisher_last_saved");
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <button
            ...
            onClick={() => {
              ...
              if (typeof window !== "undefined") {
                window.localStorage.setItem("fisher_last_saved", ts);
              }
              setLastSaved(ts);
            }}
          >
